...
二、项目背景（Demo题目）
你需要使用Django、Celery、Mysql、Redis、[GraphQL](https://github.com/graphql-python/graphene-django) 完成 [模拟面试](https://leetcode-cn.com/interview/) 相关的接口(Celery 不是必须)。
...
你需要思考业务模型，需要注意到的边界情况，之后设计表结构，完成整个大功能的接口设计。
